<!--Ping............................................................................................................. -->
<template>
    <div class="pingDiv context_box_bg"> 
        <div  >
            <div class="btnbox">
                <el-button size="mini" type="primary" :disabled="working || !form.search_field"   @click="startPing()">开始</el-button>
                <el-button size="mini" type="warning"  :disabled="!working"  @click="cancelPing()">停止</el-button>
            </div>
            <div class="search-text">
                <el-form ref="form" :model="form" :rules="rule" label-width="20px">
                    <el-form-item label="" prop="search_field">
                      <el-input placeholder="请输入服务器地址/域名地址"  size="small" clearable class="input" v-model="form.search_field"></el-input>
                    </el-form-item>
                </el-form>
        ...
        <div class="pinginfo">
            <ul class="loglist">
                <li v-for="(item,index) in pingData" :key="index">
                    <span>{{item}}</span>
                </li>
            </ul>
        </div>
...
export default ({
    ...
    methods:{ 
        startPing(){
            this.$refs.form.validate(async valid=>{
                if (valid) {
                    ...
                    const res = await auxiliarytool.openPing(params)
                    if(res.code == 200){
                        this.working = true
        ...
        async cancelPing(){
            ...
            const res = await auxiliarytool.stopPing(params)
            if(res.code == 200){ 
                this.$message({
