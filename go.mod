...
require (
	...
	gitlabee.4dogs.cn/common/captcha v1.0.1
	gitlabee.4dogs.cn/common/config v0.0.2
	gitlabee.4dogs.cn/common/encryption v0.0.0-20220816035531-056bbe0134d6
	gitlabee.4dogs.cn/common/file v0.0.4
	gitlabee.4dogs.cn/common/httpclient v0.0.4
	gitlabee.4dogs.cn/common/logger v0.0.2
	gitlabee.4dogs.cn/common/mysql v0.0.2
	gitlabee.4dogs.cn/common/redis v0.0.2
	gitlabee.4dogs.cn/common/server v0.0.2
