...
const task = {
    ...
    taskList(params){ //任务列表
        return http.get('/smart/tripartite/xraylist', params)
    },
    taskList2(params){ //burp任务列表
        return http.get('/smart/tripartite/burpsuitelist', params)
    },
    ...
    //删除/批量删除
    taskDel(params){
        return http.post('/smart/tripartite/xraydel', params)
    }, 
    //上传
    taskUpload(params){
