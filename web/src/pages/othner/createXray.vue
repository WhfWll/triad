<template>
    <div>
        <div class="main-title"> 
            <router-link :underline="false" class="classA" :to="{ path: '/x-ray' }"  >x-ray
            </router-link> 
        ...
        <BannerBox tips="任务参数通过任务场景进行默认配置，用户可以在创建任务时对默认参数进行调整。" style="margin-bottom: 16px;">
            ...
            <el-button  class="delCancel" size="small" @click="$router.push('/x-ray')" > 取消 </el-button> 
        </BannerBox>
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="12">
                            <el-form-item label="" prop="target"  class="taskNameClass">
                                <label class="dialog_item_label">测试目标<i class="is-required" style="float: right">*</i></label>
                                <el-input  v-model="taskform2.target"   size="small"
                                class="form_item_width"   placeholder="请输入测试目标" maxlength="50"></el-input>
                            ...
                            <el-form-item label="" prop=""  class="taskNameClass">
                                <label class="dialog_item_label">爬虫<i class="is-required" style="float: right">*</i></label>
                               
                                <el-switch
                                v-model="taskform2.isCrawler"
                                active-text=""
                                inactive-text="">
                                </el-switch>
                            </el-form-item> 
        ...
        submithandle(){ //保存创建任务  
            this.$refs.form.validate(async (valid) => {
                if (valid) {  
                    ...
                    const res = await task.taskSave(this.taskform2);
