...
func RecordUserLog(c *gin.Context) {
	...
	whiteApi["/smart/task/list"] = struct{}{}         // 任务列表 由于此接口存在轮询请求，暂不记录
	whiteApi["/smart/task/loginfo"] = struct{}{}      // 任务日志 由于此接口存在轮询请求，暂不记录
	whiteApi["/smart/logs/logauditlist"] = struct{}{} // 审计日志
	whiteApi["/smart/logs/enum"] = struct{}{}         // 审计日志 枚举
	whiteApi["/smart/system/authinfo"] = struct{}{}   // 产品授权查询
