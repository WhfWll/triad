  ...
  <div>
   <div class="templatelist context_box_bg" style="border-top: 1px solid #E8E8F5;  ">
     ...
     <!--  -->
       ...
       <el-table-column prop="port" label="端口" :show-overflow-tooltip = "true"> </el-table-column>
       ...
       <el-table-column prop="component" label="组件" :show-overflow-tooltip = "true"> </el-table-column>
       ...
       getData(){
        let that = this
           let params = {
            ...
            subObjType:'1_1',//string ,1_1服务，1_2站点，1_3url,1_4子域名,必选
