<template>
    <div class="taskTargetList">
            ...
            <template slot-scope="props">
              <div style="padding:0 30px">
                ...
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    ...
                    <el-tab-pane label="风险详情" name="tab1" >
                        <div >
                            <div style="margin-top:15px">
                                <span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#4c7ae3;margin-right:30px"></span>
                                <span style="margin-right:20px">漏洞名称：</span>
                                <span>远程命令执行</span>
                            </div>
                            <div style="margin-top:15px">
                                <span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#4c7ae3;margin-right:30px"></span>
                                <span style="margin-right:20px">漏洞风险：</span>
                                <span>高位</span>
                            </div>
                            <div style="margin-top:15px">
                                <span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#4c7ae3;margin-right:30px"></span>
                                <span style="margin-right:20px">漏洞地址：</span>
                                <span>127.0.0.1</span>
                            </div>
                            <div style="margin-top:15px">
                                <span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#4c7ae3;margin-right:30px"></span>
                                <span style="margin-right:20px">远控类型：</span>
                                <span>反弹shell</span>
                            </div>
                            <div style="margin-top:15px">
                                <span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:#4c7ae3;margin-right:30px"></span>
                            ...
                            <div style="margin-top:15px;border:1px solid #8a8abc;border-radius:10px">
                                      ...
                                      ridiculus mus. Nam fermentum, nulla luctus pharetra vulputate, felis tellus mollis orci,
                                       sed rhoncus pronin sapien nunc accuan eget.Lorem ipsum dolor sit amet, consectetur
                                        ...
                                        accumsan et viverra justo commodo. Proin sodales pulvinar sic tempor. Sociis natoque
                                         ...
                                         nulla luctus pharetra vulputate, felis tellus mollis orci, sed rhoncus pronin sapien 
                                         nunc accuan eget.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean
                                          euismod bibendum laoreet. Proin gravida dolor sit amet lacus accumsan et viverra 
                                          justo commodo. Proin sodales pulvinar sic tempor. Sociis natoque penatibus et magnis 
                                          dis parturient montes, nascetur ridiculus mus. Nam fermentum, nulla luctus pharetra v
                                          ulputate, felis tellus mollis orci, sed rhoncus pronin sapien nunc accuan eget.Lorem 
                                          ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. 
                                          Proin gravida dolor sit amet lacus accumsan et viverra justo commodo. Proin sodales pulvinar sic tempor. Sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nam fermentum, nulla luctus pharetra vulputate, felis tellus mollis orci, sed rhoncus pronin sapien nunc accuan eget.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida dolor sit amet lacus accumsan et viverra justo commodo. Proin sodales pulvinar sic tempor. Sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nam fermentum, nulla luctus pharetra vulputate, felis tellus mollis orci, sed rhoncus pronin sapien nunc accuan eget.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida dolor sit amet lacus accumsan et viverra justo commodo. Proin sodales pulvinar sic tempor. Sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nam fermentum, nulla luctus pharetra vulputate, felis tellus mollis orci, sed rhoncus pronin sapien nunc accuan eget.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida dolor sit amet lacus accumsan et viverra justo commodo. Proin sodales pulvinar sic tempor. Sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nam fermentum, nulla luctus pharetra vulputate, felis tellus mollis orci, sed rhoncus pronin sapien nunc accuan eget.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida dolor sit amet lacus accumsan et viverra justo commodo. Proin sodales pulvinar sic tempor. Sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nam fermentum, nulla luctus pharetra vulputate, felis tellus mollis orci, sed rhoncus pronin sapien nunc accuan eget.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida dol
                               </div>
                            </div>
                        </div>
                    </el-tab-pane>
            
                    <el-tab-pane label="文件目录" name="tab2" >
                        文件目录
                    </el-tab-pane>
                    <el-tab-pane label="已下载文件" name="tab3" >
                        已下载文件
                    </el-tab-pane>
                </el-tabs>
        ...
        <CreateReport :type="2" ref="CreateReport"  :dialogVisible = 'dialogVisible' @click="saveCreate()" @clearCreate="clearCreate()"></CreateReport>
    </div>
</template>
...
export default {
    ...
    methods:{
          handleClick(tab, event){
            ...
            if(tab.name == 'tab1'){ //风险详情
            }
            else if(tab.name == 'tab2'){  //文件目录
                
            }
         
            else if(tab.name == 'tab3'){ // 已下载文件
            }
        ...
        btnReport(row){ //点击报告 
            ...
            this.$refs.CreateReport.getinit(row.id,row.targetUrl);
        },
