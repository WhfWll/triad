<template>
    <div class="loglist">
        ...
        <el-table ref="logTable" :data="logtableData" tooltip-effect="dark" style="width: 100%" height="calc(100% - 102px)"
            ...
            <el-table-column prop="target_status" label="测试状态">
...
export default{
    ...
    methods:{
        ...
        btnShow(row){
            ...
            this.dialogtitle = row.targetUrl;
